        ...
        resources: [
            ...
            // ═══════════════════════════════════════════════════════════════
            {
                ...
                options: {
                    ...
                    listProperties: ['id', 'key_value', 'hwid', 'ip_address', 'location', 'discord_info', 'pc_name', 'timestamp'],
                    showProperties: [
                        'id', 'key_value', 'hwid', 'ip_address', 'location',
                        'discord_info', 'os_version', 'pc_name', 'cpu_info', 'gpu_info', 'ram_info', 'disk_info', 'timestamp',
                    ],
                    filterProperties: ['key_value', 'hwid', 'ip_address', 'location', 'discord_info', 'pc_name', 'timestamp'],
                    properties: {
                        id: { isTitle: false, position: 0 },
                        ...
                        location: { position: 4 },
                        discord_info: { position: 5 },
                        os_version: { position: 6 },
                        pc_name: { position: 7 },
                        cpu_info: { position: 8 },
                        gpu_info: { position: 9 },
                        ram_info: { position: 10 },
                        disk_info: { position: 11 },
                        timestamp: { position: 12, isDisabled: { edit: true, new: true } },
                    },
                    actions: {
